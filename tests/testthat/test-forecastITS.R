test_that("forecastITS works", {
  ...
  f    <- forecastITS(data = smallSimulation(n = 10, t = 20, index = 11), 
                      time = "time", INDEX = 11, covariates_time = c("year"), 
                      key = "id", 
                      y = "y", WINDOW = 8, K = 3)    

  fA    <- forecastITS(data = smallSimulation(n = 100, t = 50, index = 25), 
                      time = "time", INDEX = 25, covariates_time = c("year"), 
                      key = "id", 
                      y = "y", WINDOW = 12, K = 5)                                      

  f1    <- forecastITS(data = smallSimulation(n = 10, t = 35, index = 25), 
  ...
  fUB <- forecastITS(data = dfUB, time = "time", INDEX = 20, covariates_time = c("year"), key = "id", 
                  y = "y")
